...
@Component({
  selector: 'app-edit-sub-side-theory',
  templateUrl: './edit-sub-side-theory.page.html',
  styleUrls: ['./edit-sub-side-theory.page.scss'],
})
export class EditSubSideTheoryPage implements OnInit {
  myForm: FormGroup;
